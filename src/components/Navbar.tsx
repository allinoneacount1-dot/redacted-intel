  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-6">
        ...
        <a
          href="#clearance"
          className="font-['Oswald',_sans-serif] text-xs tracking-[0.2em] uppercase px-4 py-1.5 border transition-colors duration-200"
          style={{
            borderColor: "#D03A2B",
            color: "#D03A2B",
          }}
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            ...
            <a
              href="#clearance"
              className="font-['Oswald',_sans-serif] text-xs tracking-[0.2em] uppercase px-4 py-2 border text-center mt-2"
